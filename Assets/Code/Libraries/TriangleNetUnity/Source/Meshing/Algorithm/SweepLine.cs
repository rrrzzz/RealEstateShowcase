...
namespace TriangleNet.Meshing.Algorithm
{
    ...
    public class SweepLine : ITriangulator
    {
        ...
        public IMesh Triangulate(IList<Vertex> points, Configuration config)
        {
            ...
            // Delaunay algorithm.
            xminextreme = 10 * _TriangleNetMesh.bounds.Left - 9 * _TriangleNetMesh.bounds.Right;
            ...
            _TriangleNetMesh.MakeTriangle(ref lefttri);
            _TriangleNetMesh.MakeTriangle(ref righttri);
            ...
            while (heapsize > 0)
            {
                ...
                heapsize--;
                check4events = true;
                if (nextevent.xkey < _TriangleNetMesh.bounds.Left)
                {
                    ...
                    _TriangleNetMesh.Flip(ref fliptri);
            ...
            _TriangleNetMesh.hullsize = RemoveGhosts(ref bottommost);
        ...
        float CircleTop(Vertex pa, Vertex pb, Vertex pc, float ccwabc)
        {
            ...
            return pc.y + (xac * bclen2 - xbc * aclen2 + Mathf.Sqrt(aclen2 * bclen2 * ablen2)) / (2.0f * ccwabc);
        }
