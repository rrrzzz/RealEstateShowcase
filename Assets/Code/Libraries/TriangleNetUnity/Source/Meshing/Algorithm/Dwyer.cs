...
namespace TriangleNet.Meshing.Algorithm
{
    ...
    /// and Stolfi. Switching to a triangle-based data structure floatd the
    ...
    public class Dwyer : ITriangulator
    {
        ...
        public IMesh Triangulate(IList<Vertex> points, Configuration config)
        {
            ...
            _TriangleNetMesh.hullsize = RemoveGhosts(ref hullleft);
                        ...
                        ref Otri farright, int axis)
        {
            ...
            _TriangleNetMesh.MakeTriangle(ref baseedge);
            ...
            while (true)
            {
                ...
                if (leftfinished && rightfinished)
                {
                    ...
                    _TriangleNetMesh.MakeTriangle(ref nextedge);
                            ...
                            ref Otri farleft, ref Otri farright)
        {
            ...
            if (vertices == 2)
            {
                ...
                _TriangleNetMesh.MakeTriangle(ref farleft);
                farleft.SetOrg(sortarray[left]);
                farleft.SetDest(sortarray[left + 1]);
                // The apex is intentionally left NULL.
                _TriangleNetMesh.MakeTriangle(ref farright);
            ...
            else if (vertices == 3)
            {
                ...
                _TriangleNetMesh.MakeTriangle(ref midtri);
                _TriangleNetMesh.MakeTriangle(ref tri1);
                _TriangleNetMesh.MakeTriangle(ref tri2);
                _TriangleNetMesh.MakeTriangle(ref tri3);
