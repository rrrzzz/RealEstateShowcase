...
namespace TriangleNet.Meshing
{
    ...
    public class GenericMesher
    {
        ...
        {
            var mesh = (TriangleNetMesh)triangulator.Triangulate(polygon.Points, config);
        ...
        public static IMesh StructuredMesh(float width, float height, int nx, int ny)
        {
            if (width <= 0.0f)
            {
            ...
            return StructuredMesh(new Rectangle(0.0f, 0.0f, width, height), nx, ny);
        }
