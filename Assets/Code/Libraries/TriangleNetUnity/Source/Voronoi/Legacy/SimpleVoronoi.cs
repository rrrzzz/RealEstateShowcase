...
namespace TriangleNet.Voronoi.Legacy
{
    ...
    public class SimpleVoronoi : IVoronoi
    {
        ...
        /// </remarks>
        public SimpleVoronoi(TriangleNetMesh triangleNetMesh)
        {
        ...
        private void ComputeCircumCenters()
        {
            ...
            float ds = Math.Max(bounds.Width, bounds.Height);
        ...
        private void ConstructCell(VoronoiRegion region)
        {
            ...
            while (f_next.tri.id != TriangleNetMesh.DUMMY)
            {
            ...
            Point intersection;
            int sid, n = _TriangleNetMesh.triangles.Count;
            ...
            while (f_prev.tri.id != TriangleNetMesh.DUMMY)
            {
