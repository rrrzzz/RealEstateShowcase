...
namespace TriangleNet.Voronoi
{
    ...
    {
        public StandardVoronoi(TriangleNetMesh triangleNetMesh)
            : this(triangleNetMesh, triangleNetMesh.bounds, new DefaultVoronoiFactory(), RobustPredicates.Default)
        {
        }

        public StandardVoronoi(TriangleNetMesh triangleNetMesh, Rectangle box)
            : this(triangleNetMesh, box, new DefaultVoronoiFactory(), RobustPredicates.Default)
        {
        }
