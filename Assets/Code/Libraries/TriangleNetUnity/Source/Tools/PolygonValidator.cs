...
namespace TriangleNet.Tools
{
    ...
    public static class PolygonValidator
    {
        ...
        public static bool HasBadAngles(IPolygon poly, float threshold = 2e-12f)
        {
            var logger = Log.Instance;
        ...
        private static bool IsBadAngle(Point a, Point b, Point c, float threshold = 0.0f)
        {
            float x = DotProduct(a, b, c);
            float y = CrossProductLength(a, b, c);
        ...
        private static float CrossProductLength(Point a, Point b, Point c)
        {
