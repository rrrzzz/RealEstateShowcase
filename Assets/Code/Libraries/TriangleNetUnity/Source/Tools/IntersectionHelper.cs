...
namespace TriangleNet.Tools
{
    ...
    public static class IntersectionHelper
    {
        ...
        /// <returns>Returns false, if startpoint is outside the box.</returns>
        public static Point BoxRayIntersection(Rectangle rect, Point p, float dx, float dy)
        {
        ...
        /// <returns>Returns false, if startpoint is outside the box.</returns>
        public static bool BoxRayIntersection(Rectangle rect, Point p, float dx, float dy, ref Point c)
        {
            float x = p.X;
            float y = p.Y;
