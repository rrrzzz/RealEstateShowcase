...
namespace TriangleNet.Geometry
{
    ...
    public class Contour
    {
        ...
        /// </remarks>
        public Point FindInteriorPoint(int limit = 5, float eps = 2e-5f)
        {
            if (convex)
            {
                int count = Points.Count;

                var point = new Point(0.0f, 0.0f);
        ...
        private static Point FindPointInPolygon(List<Vertex> contour, int limit, float eps)
        {
